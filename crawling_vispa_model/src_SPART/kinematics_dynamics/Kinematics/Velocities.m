function [t0,tL]=Velocities(Bij,Bi0,P0,pm,q0_dot,q_dot,robot)
% Computes the operational-space velocities of the multibody system.
%
% [t0,tL]=Velocities(Bij,Bi0,P0,pm,q0_dot,q_dot,robot)
%
% :parameters:
...
%   * q0_dot -- Base-link velocities [\omega,rdot]. The angular velocity is projected in the body-fixed CCS, while the linear velocity is projected in the inertial CCS -- [6x1].
...
for i=1:n
    ...
    if robot.joints(i).type~=0
        tL(1:6,i)=tL(1:6,i)+pm(1:6,i)*q_dot(robot.joints(i).q_id);
    end
